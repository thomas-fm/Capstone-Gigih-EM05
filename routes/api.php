...
Route::group(['middleware' => ['jwt.verify:USER,user']], function() {
    Route::group(['middleware' => ['profile.verify']], function() {
        ...
        Route::get('user/document/id/{document_id}', [UserDocumentController::class, 'fetchUserDocumentById']);
        Route::delete('user/document/id/{document_id}', [UserDocumentController::class, 'deleteUserDocumentById']);
        ...
        Route::get('user/job-apply/id/{job_application_id}', [JobApplicationController::class, 'getApplicationDetailById']);
        Route::patch('user/job-apply/withdraw', [JobApplicationController::class, 'cancelJobApplication']);
